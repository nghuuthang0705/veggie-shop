                                    ...
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        <div class="slide-video mb-50 d-none">
                                            <a class="ltn__video-icon-2 ltn__video-icon-2-border"
                                                href="https://www.youtube.com/embed/ATI7vfCgwXE?autoplay=1&amp;showinfo=0" data-rel="lightcase:myCollection">
                                                <i class="fa fa-play"></i>
                                            </a>
                                        </div>
                                        <h6 class="slide-sub-title animated"><img src="{{ asset('assets/clients/img/icons/icon-img/1.png') }}" alt="#"> Rau
                                            củ tươi ngon mỗi ngày</h6>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        <h6 class="slide-sub-title ltn__secondary-color animated">// RAU CỦ TƯƠI SẠCH VÀ AN TOÀN</h6>
                                        <h1 class="slide-title animated ">Tươi Ngon & Bổ Dưỡng <br> Rau Củ Hữu Cơ</h1>
                                        <div class="slide-brief animated">
                                            <p>Chúng tôi cung cấp rau củ sạch, giàu dinh dưỡng, được trồng theo phương pháp hữu cơ,
                                                đảm bảo an toàn cho sức khỏe.</p>
                                        </div>
                                        <div class="btn-wrapper animated">
                                            <a href="shop.html" class="theme-btn-1 btn btn-effect-1 text-uppercase">Khám phá ngay</a>
                    ...
                    <div class="ltn__tab-menu ltn__tab-menu-2 ltn__tab-menu-top-right-- text-uppercase text-center">
                        <div class="nav">
                            @foreach ($categories as $index => $category)
                                <a class="{{ $index == 0 ? 'active show' : '' }}" data-bs-toggle="tab" href="#tab_{{ $category->id }}">{{ $category->name }}</a>
                            @endforeach
                        </div>
                    </div>
                                                    ...
                                                    <div class="product-img">
                                                        ...
                                                        <div class="product-hover-action">
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)" title="Yêu thích" class="add-to-wishlist-btn"
                                                                        data-id="{{ $product->id }}">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 align-self-center">
                    <div class="ltn__counterup-item-3 text-color-white text-center">
                        ...
                        <h1><span class="counter">50</span><span class="counterUp-letter">K</span><span class="counterUp-icon">+</span> </h1>
                            ...
                            <div class="product-img">
                                ...
                                <div class="product-hover-action">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="javascript:void(0)" title="Yêu thích" class="add-to-wishlist-btn" data-id="{{ $product->id }}">
                                                <i class="far fa-heart"></i></a>
                                        </li>
                                    </ul>
                                </div>
