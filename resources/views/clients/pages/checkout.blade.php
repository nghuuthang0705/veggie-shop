                                ...
                                <div class="card">
                                    <h5 class="collapsed ltn__card-title">
                                        ...
                                        <label for="payment_paypal">
                                            PayPal
                                            <img src="{{ asset('assets/clients/img/icons/payment-3.png') }}" alt="#">
                                        </label>
                                    </h5>
                                </div>
                            </div>
                            <div class="ltn__payment-note mt-30 mb-30">
                                <p>Dữ liệu cá nhân của bạn sẽ được sử dụng để xử lý đơn hàng, hỗ trợ trải nghiệm của bạn trên toàn bộ website này, và cho các mục
                                    đích
