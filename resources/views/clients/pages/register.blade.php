                    ...
                    <div class="account-login-inner">
                        <form action="{{ route('post-register') }}" class="ltn__form-box contact-form-box" method="POST"
                            ...
                            <label class="checkbox-inline">
                                ...
                                Tôi đồng ý cho website xử lý thông tin cá nhân nhằm cung cấp các chương trình khuyến mãi, ưu
                                đãi và thông tin sản phẩm phù hợp theo Chính sách bảo mật.
                            </label>
                            @error('checkbox1')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <label class="checkbox-inline">
                                ...
                                Bằng việc nhấn "Đăng ký", tôi đồng ý với Điều khoản sử dụng và Chính sách bảo mật của
                                website.
                            </label>
                            @error('checkbox2')
                                <div class="alert alert-danger">{{ $message }}</div>
