                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active show" id="liton_tab_dashboard">
                                            <div class="ltn__myaccount-tab-content-inner">
                                                ...
                                                <p>Từ trang tổng quan tài khoản, bạn có thể xem <span>đơn hàng gần
                                                        đây</span>, quản lý <span>địa chỉ giao hàng và địa chỉ thanh
                                                        toán</span>, cũng như <span>thay đổi mật khẩu và cập nhật thông tin
                                                        tài khoản</span>.</p>
                                            </div>
                                        </div>
                                                        ...
                                                        <tbody>
                                                            @foreach ($orders as $order)
                                                                <tr>
                                                                    ...
                                                                    <td><a href="{{ route('cart.index') }}" class="btn btn-sm btn-info">Xem chi tiết</a></td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                                    </table>
                                                ...
                                                <div class="ltn__form-box">
                                                    <form action="{{ route('account.update') }}" method="POST" id="update-account"
                                                        ...
                                                        <div class="row mb-50">
                                                            <div class="col-md-12 text-center mb-3">
                                                                <div class="profile-pic-container">
                                                                    <img src="{{ asset('storage/' . $user->avatar) }}" alt="Avatar" id="preview-image"
                                                                        class="profile-pic">
                                                        ...
                                                        <div class="btn-wrapper">
                                                            <button type="submit" class="btn theme-btn-1 btn-effect-1 text-uppercase">Cập
                                                                nhật</button>
                                                        </div>
                                                    </form>
                                                </div>
