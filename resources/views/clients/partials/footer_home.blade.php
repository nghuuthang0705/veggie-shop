            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-about-widget">
                        ...
                        <p>Chúng tôi cam kết mang đến sản phẩm an toàn, chất lượng cùng dịch vụ giao hàng nhanh chóng, giúp bữa ăn của gia đình bạn luôn tươi
                            ngon mỗi ngày.
                        </p>
                    ...
                    <div class="footer-widget footer-newsletter-widget">
                        ...
                        <div class="footer-newsletter">
                            <div id="mc_embed_signup">
                                <form action="https://gmail.us5.list-manage.com/subscribe/post?u=dde0a42ff09e8d43cad40dc82&amp;id=72d274d15d" method="post"
                                    ...
                                    <div id="mc_embed_signup_scroll">
                                        ...
                                        <div class="clear">
                                            <div class="btn-wrapper">
                                                <button class="theme-btn-1 btn" type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe"><i
