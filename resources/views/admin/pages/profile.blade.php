                        ...
                        <div class="x_content">
                            <div class="col-md-3 col-sm-3  profile_left">
                                <div class="profile_img">
                                    <div id="crop-avatar">
                                        <img class="img-responsive avatar-view img-account" id="avatar-preview" src="{{ asset('storage/' . $user->avatar) }}"
                                ...
                                <ul class="list-unstyled user_data">
                                    ...
                                    <li>
                                        <i class="fa fa-briefcase user-profile-icon"></i> <span id="user-email">{{ $user->email }}</span>
                                    </li>
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <form id="update-profile" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" id="email" name="email" required class="form-control" value="{{ $user->email }}" readonly>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                    ...
                                    <div class="item form-group">
                                        <div class="col-md-6 col-sm-6 offset-md-3">
                                            <button class="btn btn-warning form-change-password">Đổi mật khẩu</button>
                                ...
                                <form id="change-password" data-parsley-validate class="form-horizontal form-label-left" style="display: none;">
                                    <div class="ln_solid"></div>
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="current_password">Mật khẩu hiện tại <span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="new_password">Mật khẩu mới <span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="confirm_password">Xác nhận mật khẩu mới <span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
