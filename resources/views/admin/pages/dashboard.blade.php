        ...
        <div class="row">
            <div class="col-md-4 col-sm-4">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <canvas id="revenueBarChart" data-labels='@json($monthlyRevenue->pluck('month')->toArray())' data-values='@json($monthlyRevenue->pluck('revenue')->toArray())'></canvas>
                    </div>
                </div>
            </div>
                ...
                <div class="x_panel tile fixed_height_320 overflow_hidden">
                    ...
                    <div class="x_content">
                        <table class="" style="width:100%">
                            ...
                            <tr>
                                <td>
                                    <canvas class="canvasDoughnutCategory" height="140" width="140" style="margin: 15px 10px 10px 0"
                                        data-labels='@json($categories->pluck('name'))' data-counts='@json($categories->map(fn($category) => $category->products->count()))'>
                                    </canvas>
                                </td>
                                <td>
                                                ...
                                                <td>
                                                    <p>
                                                        <i class="fa fa-square"
                                                            style="color: {{ ['#BDC3C7', '#9B69B6', '#E74C3C', '#26B99A', '#4398DB'][$index % 5] }}"></i>{{ $category->name }}
                                                    </p>
                                                </td>
                            ...
                            <tbody>
                                @for ($i = 0; $i < min(3, $orders->count()); $i++)
                                    <tr>
                                        ...
                                        <td>{{ $orders[$i]->created_at->format('d-m-Y h:i A') }}</td>
                                        <td>
