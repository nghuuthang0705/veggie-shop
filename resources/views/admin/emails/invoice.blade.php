...
<body style="font-family: Arial, sans-serif; font-size: 16px; color: #333; line-height: 1.6; margin: 0; padding: 20px; background-color: #f9f9f9;">
    <div style="max-width: 700px; margin: 0 auto; background: #fff; padding: 20px; border-radius: 8px;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p>
                        ...
                        Email: nghuuthang0705@gmail.com
                    </p>
                </td>
            </tr>
        </table>
        ...
        <p
            style="background: {{ $order->payment->payment_method == 'paypal' ? 'blue' : 'green' }}; color: #fff; padding: 10px; text-align: center; border-radius: 5px;">
            {{ $order->payment->payment_method == 'paypal' ? 'Thanh toán bằng PayPal' : 'Thanh toán khi nhận hàng' }}
        </p>
        <p style="font-size: 14px; color: #777;">Nếu là PayPal, thanh toán đã được xử lý trực tuyến. Nếu là thanh toán khi nhận hàng, khách hàng sẽ thanh toán
            khi nhận sản phẩm.</p>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr style="background: #28a745; color: #fff;">
                ...
                <td style="padding: 10px; text-align: right;"><strong>{{ number_format($order->total_price, 0, ',', '.') }} VNĐ</strong></td>
            </tr>
        </table>

        <p style="text-align: center; font-size: 14px; color: #777; margin-top: 20px;">Cảm ơn bạn đã mua hàng! Nếu có bất kỳ câu hỏi nào, hãy liên hệ với chúng
            tôi.</p>
    </div>
